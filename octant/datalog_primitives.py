...
TYPES = {
    ...
    'int8': NumType('int', size=8),
    'int10': NumType('int', size=10),
    'int11': NumType('int', size=11),
    'int12': NumType('int', size=12),
    'int13': NumType('int', size=13),
    'int14': NumType('int', size=14),
    'int15': NumType('int', size=15),    
